...
public class Operations {
     ...
     */
    int changeSign(int num) { return (~num) + 1; }
     ...
     */
    int getByte(int num, int which) { return (num >> (which << 3) & 0b11111111); }
     ...
     */
    public static int swapShorts(int num) { return ((num >> 16) & (0b1111111111111111)) | (num << 16); }
     ...
     */
    int setNibble(int num, int a_nibble, int which) { return (a_nibble << (which << 2) | ~((0b1111 << (which << 2)) | ~num)); }
     ...
     */
    int pack(int b2, int s1, int b0) { return (b2 << 24 | s1 << 8| b0); }
     ...
     */
    int bitRange(int num, int s, int n) { return (~(~0x0 << n) & (num >> s)); }
     ...
     */
    int xor(int num1, int num2) { return ((num1 & ~(num2)) | (num2 & ~(num1))); }
    ...
    boolean multipleOf2(int num) { return (num == (num & ~0x1)); }
    ...
    boolean multipleOf16(int num) { return (num == (num & ~0b1111)); }
    ...
    boolean powerOf2(int num) { return ((num - 0x1) & num) == 0 && num > 0; }
}